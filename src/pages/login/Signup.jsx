        ...
        <div className="auth-page inner">
            <div className="auth-page__layout">
                ...
                <div className="auth-page__image">
                    <img src="https://images.unsplash.com/photo-1612817288484-6f916006741a?w=800&q=80" alt="Aesop Signup" />
                </div>

                {/* 오른쪽 폼 영역 */}
                <div className="auth-page__container">
                    <h2 className="font-serif auth-page__title">Join Us</h2>
                    <p className="auth-page__desc">
                        Aesop 이커머스에서 다양한 헤택을 위해<br/>회원가입을 진행해주세요.
                    </p>
                    ...
                    <button type="submit" className="btn-outline auth-form__submit mt-2">
                        Sign up
                    </button>
