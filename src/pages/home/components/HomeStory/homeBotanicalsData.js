export const HORIZONTAL_WIDTH = 6040;
...
export const HORIZONTAL_SCROLL_END = 0.92;
export const HORIZONTAL_SCROLL_START = 0.2;
export const SECTION_EXIT_BUFFER_RATIO = 0.6;
export const TARGET_VISIBLE_WIDTH = 2200;
export const STAGE_SCALE_REDUCTION = 0.82;
export const STAGE_VERTICAL_BIAS = 40;
